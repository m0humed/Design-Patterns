...
public class DishFactory1    
{

    public static IAppetizer CreateAppetizer(string Appetizer)
    {
    ...
    public static IMainCourse CreateMainCourse(string MainCourse)
    {
        return MainCourse switch
        {
    ...
    public static IDessert CreateDessert(string Dessert)
    {
